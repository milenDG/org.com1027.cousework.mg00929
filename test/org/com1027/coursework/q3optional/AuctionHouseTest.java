...
public class AuctionHouseTest {
  ...
  public void testEndAuctionWithNoBidsOrPurchases() {
    ...
    assertThat(ahouse1.displayUnsoldProducts(), 
       anyOf(is("1 - teddy"+"\n"+"2 - doll with 5 remaining"+"\n"), is("2 - doll with 5 remaining"+"\n"+"1 - teddy"+"\n")));
 } 
  ...
  public void testEndAuctionWithBidsMeetingReserve() {
    ...
    BiddableProduct product2 = new BiddableProduct(2,"doll",20.00);
    User user = new User("Stella");
    assertEquals(true,ahouse1.register(product1, user));  
    assertEquals(true,ahouse1.register(product2, user)); 
    ...
    assertThat(ahouse1.displaySoldProducts(), 
        anyOf(is("1 - teddy - S***a bid £12.0"+"\n"+"2 - doll - S***a bid £22.0"+"\n"),
            is("2 - doll - S***a bid £22.0"+"\n"+"1 - teddy - S***a bid £12.0"+"\n")));
 } 
  ...
  public void testEndAuctionWithBuyNowLeft() {
    ...
    //so the assert needs to be more complex than just assertEquals
    assertThat(ahouse1.displayUnsoldProducts(), 
         anyOf(is("1 - teddy with 4 remaining"+"\n"+"2 - doll with 5 remaining"+"\n"), is("2 - doll with 5 remaining"+"\n"+"1 - teddy with 4 remaining"+"\n")));
  ...
  public void testEndAuctionWithBuyNowSold() {
    ...
    //System.out.println(ahouse1.displayUnsoldProducts());
    assertThat(ahouse1.displaySoldProducts(), 
        anyOf(is("1 - teddy - S***a bought 9\n"+"2 - doll - S***a bought 5\n"),
            is("2 - doll - S***a bought 5\n"+"1 - teddy - S***a bought 9\n")));
  ...
  /*
   * Create a test scenario with two buy now products with 5 and 10 quantities respectively.
   * Register and buy 3 and 7 of them respectively.
   * Display should display 3 and 7 in the sold display and also show
   * the product being unsold. 
   * 
   * The model is too coarse to be able to display the quantities remaining of the unsold ones.
   * 
  ...
  public void testEntriesForBuyNowProduct() {
    AuctionHouse ahouse1 = new AuctionHouse();
    BuyNowProduct product1 = new BuyNowProduct(1,"doll",20.00,5);
    BuyNowProduct product2 = new BuyNowProduct(2,"ball",5.00,10);
    User user = new User("Stella");
    user.displayPurchases();
    ahouse1.register(product1, user);  
    ahouse1.register(product2, user);  
    ...
    assertEquals("1 - doll - S***a bought 3\n" +
        "2 - ball - S***a bought 7\n", ahouse1.displaySoldProducts());
    assertEquals("1 - doll with 2 remaining\n" +
        "2 - ball with 3 remaining\n", ahouse1.displayUnsoldProducts());
 } 
}
